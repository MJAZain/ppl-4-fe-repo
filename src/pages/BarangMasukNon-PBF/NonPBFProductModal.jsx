...
export default function NonPBFProductModal({ isOpen, onClose, onSave, initialData = null }) {
  ...
  const order_number = JSON.parse(localStorage.getItem("nonpbfForm") || "{}")?.order_number || "";
  ...
  const handleSave = () => {
    ...
    const existing = JSON.parse(localStorage.getItem("nonpbfList") || "[]");
    ...
    localStorage.setItem("nonpbfList", JSON.stringify(updated));
    onSave(updated);
    onClose();
  };
